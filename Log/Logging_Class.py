...
# -*- coding: utf-8 -*-
# ##
# @brief    [Logger] Logging Class for controlling our command and log file in Autonomous System Laboratory
...
class NodeLogger(object):
    ...
    """   
    def __init__(self, platform_name="Batch Synthesis Server", setLevel="DEBUG",SAVE_DIR_PATH="/home/preprocess/catkin_ws/src/doosan-robot/Log/"):
