...
DXL_POSITION_VALUE1  = 600           # Dynamixel will rotate between this value
DXL_POSITION_VALUE2  = 500           # and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
DXL_MOVING_STATUS_THRESHOLD = 10                # Dynamixel moving status threshold

dxl_goal_position = [DXL_POSITION_VALUE1, DXL_POSITION_VALUE2]         # Goal position
...
param_goal_position1 = [DXL_LOBYTE(DXL_LOWORD(dxl_goal_position[0])),
...
param_goal_position2 = [DXL_LOBYTE(DXL_LOWORD(dxl_goal_position[1])),
                           DXL_HIBYTE(DXL_LOWORD(dxl_goal_position[1])),
                           DXL_LOBYTE(DXL_HIWORD(dxl_goal_position[1])),
                           DXL_HIBYTE(DXL_HIWORD(dxl_goal_position[1]))]
...
while 1:
    ...
    print("[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL1_ID, dxl_goal_position[0], dxl1_present_position, DXL2_ID, dxl_goal_position[1], dxl2_present_position))

    if (abs(dxl_goal_position[0] - dxl1_present_position) <= DXL_MOVING_STATUS_THRESHOLD) and (abs(dxl_goal_position[1] - dxl2_present_position) <= DXL_MOVING_STATUS_THRESHOLD):
        break
