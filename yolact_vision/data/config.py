...
COCO_CLASSES = ('holder','falcon','liquid','precipitate')
# custom_category_ids = [1969519419, 3090355692,630154067,3601361085]  # 주어진 ID 리스트
# # COCO_LABEL_MAP = {cat_id: i for i, cat_id in enumerate(custom_category_ids)}
# COCO_LABEL_MAP = {1969519419:1, 3090355692:2, 630154067:3,3601361085:4}

# COCO_CLASSES = ("falconStorage","empty","cappedfalcon","uncappedfalcon")

# custom_category_ids = [1,2,3,4]  # 주어진 ID 리스트
# COCO_LABEL_MAP = {cat_id: i for i, cat_id in enumerate(custom_category_ids)}
...
dataset_base = Config({
    ...
    'train_images': '/home/preprocess/catkin_ws/src/doosan-robot/yolact_vision/dataset/Washing/LDH_Ir_Washing_1926_250103/train',
    'train_info':   '/home/preprocess/catkin_ws/src/doosan-robot/yolact_vision/dataset/Washing/LDH_Ir_Washing_1926_250103/train/train.json',

    # Validation images and annotations.
    'valid_images': '/home/preprocess/catkin_ws/src/doosan-robot/yolact_vision/dataset/Washing/LDH_Ir_Washing_1926_250103/val',
    'valid_info':   '/home/preprocess/catkin_ws/src/doosan-robot/yolact_vision/dataset/Washing/LDH_Ir_Washing_1926_250103/val/val.json',
...
coco2014_dataset = dataset_base.copy({
    ...
    # 'train_info': 'C:/Users/heeseung/Desktop/Code/yolact/dataset/train/train.json',
    # 'valid_info': 'C:/Users/heeseung/Desktop/Code/yolact/dataset/train/train.json',
